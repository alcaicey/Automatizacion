...
@api_bp.route('/stock_history/<symbol>', methods=['GET'])
...
@api_bp.route('/api/kpi/analyze/<nemo>', methods=['GET'])
async def analyze_kpi(nemo):
    ...
    try:
        from src.scripts.ai_financial_service import AIFinancialService
...
@api_bp.route('/api/dividends/columns', methods=['GET', 'POST'])
@login_required
